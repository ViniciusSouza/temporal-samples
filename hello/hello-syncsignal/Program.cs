...
// Normal Temporal signals are fire-and-forget.  This means that when a caller sends
// a signal that the send method will return once the signal has been submitted to
// Temporal and the caller will not know when the signal will actually be received
